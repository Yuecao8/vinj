<template>
  <div class="wrapper" v-wechat-title="'活动详情_视觉南京'" v-if="requested">
    <div class="top">
      <p class="title">活动稿件</p>
      <img src="../../assets/images/detail/back2.png" @click="goBack" alt />
    </div>
    <img class="top-img" :src="detail.index_pic_url+'?imageView/0/h/217/w/375'" alt />
    <div class="main-box">
    ...
    <div class="list-box p15">
      ...
      >
        <div class="img-box">
          <img class="fullImg" v-if="item.index_pic" :src="item.index_pic+'?imageView/0/h/70/w/100'" alt />
      ...
      <div
        ...
        @click="loadMore"
        style="padding:0.15rem 0;margin-top:0;"
      >
  ...
  methods: {
    ...
    getList (id) {
      const param = {
        ...
        per_num: this.count,
        activity_id: id,
        committee_member_id: window.localStorage.getItem('memberId')
      }
