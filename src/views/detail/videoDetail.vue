<template>
  <div class="wrapper" v-wechat-title="this.detail.title+'_视觉南京'" v-if="detail.id">
    <div class="video-box">
      <video v-if="detail.indexpic" :src="detail.video.host+detail.video.dir+detail.video.filepath+detail.video.filename" class="video fullImg" controls :poster="detail.indexpic.host+detail.indexpic.dir+detail.indexpic.filepath+detail.indexpic.filename"></video>
