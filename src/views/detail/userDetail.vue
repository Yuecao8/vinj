<template>
  <div class="my-wrapper" v-wechat-title="this.userInfo.nick_name+'_视觉南京'">
    <!-- 顶部 个人资料 -->
    <div class="my-top">
      ...
      <div class="my-info flexBox">
        <img
          ...
          class="avatar"
          :src="userInfo.avatar+'?imageView/0/h/84/w/84'"
          alt
        />
      ...
      <div class="my-number-box flexBox">
        <div class="my-number-item flexBox flexMiddle flexColumn">
          <p class="number-text">{{userInfo.works}}</p>
        ...
        <div class="my-number-item flexBox flexMiddle flexColumn">
          <p class="number-text">{{userInfo.clicks}}</p>
          <div class="flexBox flexAlign">
    ...
    <div class="main" v-if="currentTab === 0 && workRequested">
      <div class="work-contribute-box" style="padding-top:0.15rem;">
        <div class="img-box flexBox flexBetween flexWrap p15">
          <div class="img-item" v-for="(item,index) in workList" :key="index" @click="goImgDetail(item)">
            <img
              ...
              :src="item.index_pic+'?imageView/0/h/112/w/170'"
              alt
            />
             <img v-else class="no-data-img fullImg" src="../../assets/images/nodata/home_list.png" alt />
            <div
        ...
        <!-- 加载更多 -->
        <div
          v-if="workList.length && workHasMore"
          class="load-more flexBox flexAlign flexMiddle"
          @click="getMoreCollection"
          style="padding:0.15rem 0;margin-top:0;width:100%;"
        >
    ...
    <div class="main" v-if="currentTab === 1 && collectionRequested">
      ...
      <div class="img-box flexBox flexBetween flexWrap" style="padding:0.15rem;">
        <div class="img-item" v-for="(item,index) in collectionList" :key="index" @click="goImgDetail(item)">
          <img style="width:100%;height:100%;" :src="item.index_pic+'?imageView/0/h/112/w/170'" alt />
          <div
            v-if="item.type == 1"
            class="img-info flexBox flexAlign flexBetween"
        ...
        <!-- 加载更多 -->
        <div
          v-if="collectionList.length && collectHasMore"
          class="load-more flexBox flexAlign flexMiddle"
          @click="getMoreCollection"
          style="padding:0.15rem 0;margin-top:0;width:100%;"
        >
